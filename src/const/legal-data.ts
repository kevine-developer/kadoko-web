  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'L\'Éditeur s\'engage à ne jamais vendre vos données. Cependant, pour le fonctionnement technique, certaines données sont traitées par nos prestataires de confiance :\n\n- Hébergement BDD (PostgreSQL) : <a href="https://www.ionos.fr" target="_blank" class="hover:underline">IONOS</a> (Allemagne/UE).\n- Authentification : Google (si utilisé pour la connexion).\n- Emails transactionnels : <a href="https://resend.com" target="_blank" class="hover:underline">Resend</a> (USA, conforme Data Privacy Framework). Votre email est transmis à Resend uniquement pour l\'envoi des notifications (codes d\'accès, invitations).',
      },
      {
